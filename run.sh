...
# ===========================================
python train.py --loss_type focal --weighted_sampler
...
# ===========================================
python train.py --loss_type crossentropy --weighted_loss
...
# 适用: 传统方法，数据量充足时的选择
# ===========================================
python train.py --loss_type crossentropy --weighted_samplers